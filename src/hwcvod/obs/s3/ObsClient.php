...
use hwcvod\obs\common\SdkCurlFactory;
use hwcvod\obs\common\SdkStreamHandler;
...
/**
 * @method Model createV4SignedUrl(array $args = []);
 * @method Model createV4PostSignature(array $args=[]);
 * @method Model createV2SignedUrl(array $args=[]);
 ...
 * @method Model setBucketLoggingConfiguration(array $args = []);
 * @method Model getBucketLoggingConfiguration(array $args = []);
 * @method Model setBucketPolicy(array $args = []);
 * @method Model getBucketPolicy(array $args = []);
 * @method Model deleteBucketPolicy(array $args = []);
 * @method Model setBucketLifecycleConfiguration(array $args = []);
 * @method Model getBucketLifecycleConfiguration(array $args = []);
 * @method Model deleteBucketLifecycleConfiguration(array $args = []);
 * @method Model setBucketWebsiteConfiguration(array $args = []);
 * @method Model getBucketWebsiteConfiguration(array $args = []);
 * @method Model deleteBucketWebsiteConfiguration(array $args = []);
 * @method Model setBucketVersioningConfiguration(array $args = []);
 * @method Model getBucketVersioningConfiguration(array $args = []);
 ...
 * @method Model initiateMultipartUpload(array $args = [],array $args2 = []);
 * @method Model uploadPart(array $args = []);
 * @method Model copyPart(array $args = []);
 * @method Model listParts(array $args = [],array $args2 = []);
 * @method Model completeMultipartUpload(array $args = [],array $args2 = []);
 ...
 * @method Promise setBucketLoggingConfigurationAsync(array $args = [], callable $callback);
 * @method Promise getBucketLoggingConfigurationAsync(array $args = [], callable $callback);
 ...
 * @method Promise setBucketLifecycleConfigurationAsync(array $args = [], callable $callback);
 * @method Promise getBucketLifecycleConfigurationAsync(array $args = [], callable $callback);
 * @method Promise deleteBucketLifecycleConfigurationAsync(array $args = [], callable $callback);
 * @method Promise setBucketWebsiteConfigurationAsync(array $args = [], callable $callback);
 * @method Promise getBucketWebsiteConfigurationAsync(array $args = [], callable $callback);
 * @method Promise deleteBucketWebsiteConfigurationAsync(array $args = [], callable $callback);
 * @method Promise setBucketVersioningConfigurationAsync(array $args = [], callable $callback);
 * @method Promise getBucketVersioningConfigurationAsync(array $args = [], callable $callback);
 ...
 * @method Promise uploadPartAsync(array $args = [],array $args2 = [],callable $callback);
...
class ObsClient{
	...
	const StorageClassWarm = 'STANDARD_IA';
	const StorageClassCold = 'GLACIER';
	...
	const GroupAllUsers = 'http://acs.amazonaws.com/groups/global/AllUsers';
	const GroupAuthenticatedUsers = 'http://acs.amazonaws.com/groups/global/AuthenticatedUsers';
	const GroupLogDelivery = 'http://acs.amazonaws.com/groups/s3/LogDelivery';
	...
	public function initLog(array $logConfig= [])
	{
		...
		S3Log::commonLog(WARNING, implode("];[", $msg));
	}
