<?php
namespace hwcvod\obs\s3\resource;
...
class RequestResource {
	const RESOURCE_ARRAY = [ 
			...
			'aliases' => [ 
					...
					// SDK 1.x Aliases
					'getBucketHeaders' => 'getBucketMetadata',
					'getObjectHeaders' => 'getObjectMetadata',
					'createObject' => 'putObject',
					'deleteMultipleObjects' => 'deleteObjects',
					'putObjectCopy' => 'copyObject',
					'getLogs' => 'getBucketLoggingConfiguration',
					'getVersioningStatus' => 'getBucketVersioningConfiguration',
					'createBucketNotification' => 'putBucketNotification',
					'getBucketNotifications' => 'getBucketNotification',
					'createWebsiteConfig' => 'setBucketWebsiteConfiguration',
					'getWebsiteConfig' => 'getBucketWebsiteConfiguration',
					'deleteWebsiteConfig' => 'deleteBucketWebsiteConfiguration',
					'createObjectExpirationConfig' => 'setBucketLifecycleConfiguration',
					'getObjectExpirationConfig' => 'getBucketLifecycleConfiguration',
					'deleteObjectExpirationConfig' => 'deleteBucketLifecycle',
					'setBucketNotificationConfiguration' => 'setBucketNotification',
					'getBucketNotificationConfiguration' => 'setBucketNotification',
			] 
	];
}